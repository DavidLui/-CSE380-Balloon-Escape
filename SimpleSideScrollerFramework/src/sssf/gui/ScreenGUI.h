...
private:
	...
	list<LifeStatus*> *lifeStatusImages;
...
public:
	...
	void addLifeStatus(LifeStatus *imageToAdd);
	void addRenderItemsToRenderList(RenderList *renderList, unsigned int playerLife, unsigned int lives);
