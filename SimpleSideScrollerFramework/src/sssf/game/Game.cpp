...
void Game::quitGame()
{
	...
	/*PhysicalProperties *playerProps = gsm->getSpriteManager()->getPlayer()->getPhysicalProperties();
...
void Game::setCurrentLevel(wstring initCurrentLevelFileName, wstring initCurrentLevelDir)
{ 
	currentLevelFileName = initCurrentLevelFileName; 
	currentLevelDir = initCurrentLevelDir;
}