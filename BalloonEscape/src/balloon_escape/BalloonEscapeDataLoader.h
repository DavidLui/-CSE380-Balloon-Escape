/*
	...
	BalloonEscapeDataLoader.h

	This class provides a custom importer for the BalloonEscapeGame to import
...
class BalloonEscapeDataLoader : public GameDataLoader
{
private:
...
public:
	...
	// ARE ALL DEFINED IN BalloonEscapeDataLoader.cpp
	void loadGame(Game *game, wstring gameInitFile);
	void loadGUI(Game *game, wstring guiInitFile);
	void loadWorld(Game *game, wstring levelInitDir, wstring levelInitFile);
	...
	void initGameOverScreen(Game *game, GameGUI *gui,	DirectXTextureManager *guiTextureManager);
	void victoryScreen(Game *game, GameGUI *gui,	DirectXTextureManager *guiTextureManager);
	void helpScreen(Game *game, GameGUI *gui,	DirectXTextureManager *guiTextureManager);
	void aboutScreen(Game *game, GameGUI *gui,	DirectXTextureManager *guiTextureManager);
